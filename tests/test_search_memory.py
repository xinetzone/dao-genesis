...
def test_search_index_success(mock_cache_dir):
    ...
    mock_data = [
        {"review_id": "REV-001", "task_type": "Bug Fix",
            "status": "active", "conclusions": ["Fixed the issue"]},
        {"review_id": "REV-002", "task_type": "Feature",
            "status": "active", "action_items": ["Implement feature X"]},
        {"review_id": "REV-003", "task_type": "Bug Fix Archived",
            "status": "archived", "conclusions": ["Archived fix"]}
    ]
